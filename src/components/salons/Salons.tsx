        ...
        <div className="flex items-center flex-wrap gap-2">
          {auth?.permissions.find((per) => per === "vendor-create") && (
            <button
              ...
              onClick={openModal}
            >
              <BiPlusCircle className="text-xl" /> Add Salon account
            </button>
          )}
          <button
              ...
              <div className="py-4 grid grid-cols-1 lg:grid-cols-2 gap-8 ">
                <div className="form-control">
                  <label className="label">
                    <span className="label-text">Salon name (Arabic)</span>
                  </label>
                ...
                <div className="form-control">
                  <label className="label">
                    <span className="label-text">Salon name (English)</span>
                  </label>
                  <div className="flex  items-center gap-2">
                    <input
                      type="text"
                ...
                <div className="form-control">
                  <label className="label">
                    <span className="label-text">Work start day</span>
                  </label>
                  <div className="flex items-center gap-2">
                    <input
                      type="text"
                ...
                <div className="form-control">
                  <label className="label">
                    <span className="label-text">Work end day</span>
                  </label>
                  <div className="flex items-center gap-2">
                    <input
                      type="text"
                ...
                <div className="form-control">
                  <label className="label">
                    <span className="label-text">Work end time</span>
                  </label>
                  <div className="flex items-center gap-2">
                    <input
                      type="text"

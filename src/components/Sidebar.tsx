...
const Sidebar = React.memo(
  ({ onSidebarToggle }: { onSidebarToggle: (bool: boolean) => void }) => {
    ...
    const handleLogOutButton = async () => {
      try {
        ...
        localStorage.removeItem("womnizAuth"); // Adjust based on your storage method
        localStorage.removeItem("womnizAuthToken"); // Adjust based on your storage method
        setAuth(null);
